...
## Source Of Truth
Keep this file in sync with `.github/copilot-instructions.md`. If they diverge, update both in the same change.
...
When major systems are added, moved, or removed, update this file and `.github/copilot-instructions.md` before merging.
